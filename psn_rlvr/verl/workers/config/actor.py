...
class ActorConfig(BaseConfig):
    ...
    _mutable_fields = BaseConfig._mutable_fields | {
        "ppo_mini_batch_size",
        "ppo_mini_batch_size_normalized",
    ...
    # If set, used as normalized mini batch size instead of (ppo_mini_batch_size * rollout.n // num_gpus).
    # Must be divisible by ppo_micro_batch_size_per_gpu.
    ppo_mini_batch_size_normalized: Optional[int] = None
    ...
    # Adaptive parameter noise controls (used by rollout).
    adaptive_noise: bool = False
    adaptive_noise_target_kl: float = 0.005
    adaptive_noise_coeff: float = 1.01
    adaptive_noise_min_sigma: float = 1e-6
    adaptive_noise_max_sigma: float = 0.5
    adaptive_noise_initial_sigma: float = 0.001
